  ...
  <div class="submitform">
    <div v-if="!submitted">
        ...
        <div class="form-group">
          ...
          <input type="number" class="form-control" id="login" required v-model="employee.login" name="login">
        </div>
         <div class="form-group">
        ...
        <button v-on:click="saveCustomer" class="btn btn-success">Enviar</button>
    </div>
